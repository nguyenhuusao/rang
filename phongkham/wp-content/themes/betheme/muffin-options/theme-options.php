		...
		$sections['general'] = array(
			...
			'fields' 	=> array(
				...
				array(
					...
					'desc' 		=> __('ALPHA version | This option now includes ONLY styles for some elements and will be gradually developed.<br />Currently includes: accordion, faq, tabs, vertical tabs, table', 'mfn-opts'),
					'options' 	=> array(
		...
		$sections['portfolio'] = array(
			...
			'fields'	=> array(
				...
				array(
					...
					'options' 	=> array(
						'flat col-3'	=> array('title' => 'Flat | 3 columns', 'img' => MFN_OPTIONS_URI.'img/flat.png'),
						'flat col-4'	=> array('title' => 'Flat | 4 columns', 'img' => MFN_OPTIONS_URI.'img/flat-4.png'),
		...
		$sections['pages-under'] = array(
			...
			'fields'	=> array(
				...
				array(
					...
					'desc' 		=> __('Leave this field <b>blank</b> if you want to use <b>default</b> Under Construction page.<br /><b>Notice</b>: Page Options are disabled. Plugins may NOT work on this page. Visual Composer do NOT work on this page.', 'mfn-opts'),
					'args' 		=> array(),
				),
