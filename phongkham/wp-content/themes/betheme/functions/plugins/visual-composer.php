		...
		vc_map( array (
			...
			'params' 		=> array (
				...
				array(
					'param_name' 	=> 'styles',
					'type' 			=> 'textarea',
					'heading' 		=> __('Styles', 'mfn-opts'),
					'description' 	=> __('You can get predefined styles from <a target="_blank" href="http://snazzymaps.com/">snazzymaps.com</a> or generate your own <a target="_blank" href="http://gmaps-samples-v3.googlecode.com/svn/trunk/styledmaps/wizard/index.html">here</a>', 'mfn-opts'),
					'admin_label'	=> false,
				),
